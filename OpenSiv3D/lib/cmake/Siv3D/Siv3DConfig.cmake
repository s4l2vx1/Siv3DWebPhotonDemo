...
foreach(_cmake_expected_target IN ITEMS Siv3D::Siv3D Siv3D::Siv3DInterface Siv3D::Siv3DPrivateInterface Siv3D::Siv3DBrowserImageEncodeDecode Siv3D::Siv3DScript Siv3D::Siv3DWebGPU)
...
set_target_properties(Siv3D::Siv3DInterface PROPERTIES
  ...
  INTERFACE_COMPILE_OPTIONS "\$<\$<COMPILE_LANGUAGE:CXX>:;-Wall;-Wextra;-Wno-unknown-pragmas;-Wno-enum-constexpr-conversion;-fexceptions;-fcolor-diagnostics;\$<\$<CONFIG:Debug>:;-g3;-O0;-pg;-DDEBUG>;\$<\$<CONFIG:Release>:;-O2;-DNDEBUG>;\$<\$<CONFIG:RelWithDebInfo>:;-g3;-Og;-pg>;\$<\$<CONFIG:MinSizeRel>:;-Os;-DNDEBUG>;>;\$<\$<COMPILE_LANGUAGE:C>:;-Wall;-Wextra;-Wno-missing-field-initializers;-fcolor-diagnostics;\$<\$<CONFIG:Debug>:;-g3;-O0;-pg;-DDEBUG>;\$<\$<CONFIG:Release>:;-O2;-DNDEBUG>;\$<\$<CONFIG:RelWithDebInfo>:;-g3;-Og;-pg>;\$<\$<CONFIG:MinSizeRel>:;-Os;-DNDEBUG>;>"
  INTERFACE_LINK_OPTIONS "--js-library=${_IMPORT_PREFIX}/lib/Siv3D/Siv3D.js;--pre-js=${_IMPORT_PREFIX}/lib/Siv3D/Siv3D.pre.js;--post-js=${_IMPORT_PREFIX}/lib/Siv3D/Siv3D.post.js;-sUSE_GLFW=3;-sUSE_OGG=1;-sUSE_VORBIS=1;-sFULL_ES3;-sMIN_WEBGL_VERSION=2;-sMAX_WEBGL_VERSION=2;-sERROR_ON_UNDEFINED_SYMBOLS=0;-sALLOW_MEMORY_GROWTH=1"
)
...
set_target_properties(Siv3D::Siv3DPrivateInterface PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "C:/Workspace/OpenSiv3D/Web/"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/Siv3DConfig-*.cmake")
