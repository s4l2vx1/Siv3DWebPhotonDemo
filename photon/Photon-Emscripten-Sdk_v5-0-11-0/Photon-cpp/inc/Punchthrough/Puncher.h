	...
	namespace Photon
	{
		...
		namespace Punchthrough
		{
			...
			private:
				...
				bool sendPong(const Internal::Punchthrough::Forwards::SockaddrIn& remoteAddr);
				bool sendStunRelay(int remoteid, Internal::Punchthrough::Forwards::StunMsgType stunMsgType, const nByte* pMsgID);
				bool sendStunDirect(const Internal::Punchthrough::Forwards::SockaddrIn& remoteAddr, Internal::Punchthrough::Forwards::StunMsgType stunMsgType, const nByte* pMsgID);

				bool sendRelay(bool reliable, const Common::JVector<nByte>& buffer, const Common::JVector<int>& targetIDs);

				// :: Builders
				Common::JVector<nByte> buildMsgBindingRequest(void);
				Common::JVector<nByte> buildStunImplementation(int id, Internal::Punchthrough::Forwards::StunMsgType stunMsgType, const nByte* pMsgID);
