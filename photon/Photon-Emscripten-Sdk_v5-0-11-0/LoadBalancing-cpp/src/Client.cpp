...
#	pragma warning(disable:4355)
			...
			, mUseUDPEncryption(clientConstructOptions.getSerializationProtocol()==ConnectionProtocol::UDP&&mUseAuthOnce)
...
#endif
			if(mpPeer->connect(addPortToAddress(serverAddressWithoutProtocol, connectOptions.getServerType()), mAppIDPeerInit))
			{
				JString userID;
