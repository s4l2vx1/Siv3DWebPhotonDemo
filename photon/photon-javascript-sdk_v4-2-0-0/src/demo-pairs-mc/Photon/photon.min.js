...
Photon;
(function(g){var d;(function(h){h[h.OFF=0]="OFF";h[h.ERROR=1]="ERROR";h[h.WARN=2]="WARN";h[h.INFO=3]="INFO";h[h.DEBUG=4]="DEBUG"})(d=g.LogLevel||(g.LogLevel={}));var p=function(){function h(f,l){void 0===f&&(f="");void 0===l&&(l=d.INFO);this.prefix=f;this.level=l}h.prototype.setPrefix=function(f){this.prefix=f};h.prototype.getPrefix=function(){return this.prefix};h.prototype.setLevel=function(f){f=Math.max(f,d.OFF);this.level=f=Math.min(f,d.DEBUG)};h.setExceptionHandler=function(f){this.exceptionHandler=f};
h.prototype.isLevelEnabled=function(f){return f<=this.level};h.prototype.getLevel=function(){return this.level};h.prototype.debug=function(f){for(var l=[],n=1;n<arguments.length;n++)l[n-1]=arguments[n];this.log(d.DEBUG,f,l)};h.prototype.info=function(f){for(var l=[],n=1;n<arguments.length;n++)l[n-1]=arguments[n];this.log(d.INFO,f,l)};h.prototype.warn=function(f){for(var l=[],n=1;n<arguments.length;n++)l[n-1]=arguments[n];this.log(d.WARN,f,l)};h.prototype.error=function(f){for(var l=[],n=1;n<arguments.length;n++)l[n-
1]=arguments[n];this.log(d.ERROR,f,l)};h.prototype.exception=function(f,l){for(var n=[],q=2;q<arguments.length;q++)n[q-2]=arguments[q];if(!h.exceptionHandler||!h.exceptionHandler(f,this.format0(l,n)))throw Error(this.format0("["+f+"] "+l,n));};h.prototype.format=function(f){for(var l=[],n=1;n<arguments.length;n++)l[n-1]=arguments[n];return this.format0(f,l)};h.prototype.formatArr=function(f,l){return this.format0(f,l)};h.prototype.log=function(f,l,n){if(f<=this.level&&"undefined"!==typeof console&&
void 0!==l)try{var q;(q=console.hasOwnProperty(h.log_types[f])?console[h.log_types[f]]:console.log)&&q.apply(console,[this.prefix,l].concat(n))}catch(r){}};h.prototype.format0=function(f,l){return(""==this.prefix?"":this.prefix+" ")+f+" "+l.map(function(n){if(void 0!==n)switch(typeof n){case "object":try{return JSON.stringify(n)}catch(q){return n.toString()+"("+q+")"}default:return n.toString()}}).join(" ")};h.log_types=["error","error","warn","info","debug"];return h}();g.Logger=p;p=function(){function h(){}
h.isArray=function(f){return"[object Array]"===Object.prototype.toString.call(f)};h.getPropertyOrElse=function(f,l,n){return f.hasOwnProperty(l)?f[l]:n};return h}();g.Util=p})(Photon||(Photon={}));
(function(g){g.setOnLoad=function(h){h()};var d;(function(h){h[h.Ws=0]="Ws";h[h.Wss=1]="Wss"})(d=g.ConnectionProtocol||(g.ConnectionProtocol={}));(function(h){h[h.None=0]="None";h[h.Byte=1]="Byte";h[h.Short=2]="Short";h[h.Int=3]="Int";h[h.Long=4]="Long";h[h.Float=5]="Float";h[h.Double=6]="Double";h[h.String=7]="String";h[h.Bool=8]="Bool";h[h.Table=9]="Table";h[h.Dict=10]="Dict";h[h.Object=11]="Object"})(g.TypeExtType||(g.TypeExtType={}));var p=function(){function h(){}h.Is=function(f){return!1};h.Byte=
function(f){return f};h.Short=function(f){return f};h.Int=function(f){return f};h.Long=function(f){return f};h.Float=function(f){return f};h.Double=function(f){return f};h.String=function(f){return f};h.Bool=function(f){return f};h.Dict=function(f,l,n){return n};h.TableTypedKeys=function(){return{}};h.DictTypedKeys=function(f,l){return{}};h.PutTypedKey=function(f,l,n){f[l]=n};return h}();g.TypeExt=p;p=function(){function h(f,l,n,q){void 0===n&&(n="");void 0===q&&(q="");this.protocol=f;this.address=
l;this.subprotocol=n;this.keepAliveTimeoutMs=3E3;this._frame="~m~";this._isClosing=this._isConnected=this._isConnecting=!1;this._peerStatusListeners={};this._eventListeners={};this._responseListeners={};this.lastRtt=0;this.initTimestamp=Date.now();this.serverTimeBaseLock=!1;this.serverTimeBase=0;this.serverTimeBaseTimestamp=Date.now();this.keepAliveTimer=0;this.url=this.addProtocolPrefix(this.address,this.protocol);this._logger=new g.Logger(q&&""!=q?q+":":"")}h.prototype.addProtocolPrefix=function(f,
l){var n={ws:"ws://",wss:"wss://"},q;for(q in n)if(0==f.indexOf(n[q]))return f;switch(l){case d.Ws:return n.ws+f;case d.Wss:return n.wss+f;default:return n.ws+f}};h.prototype.Destroy=function(){};h.prototype.isConnecting=function(){return this._isConnecting};h.prototype.getRtt=function(){return this.lastRtt};h.prototype.getServerTimeMs=function(){return this.serverTimeBase+(Date.now()-this.serverTimeBaseTimestamp)>>0};h.prototype.ping=function(f){void 0===f&&(f=!1);this._ping(f)};h.prototype.isConnected=
function(){return this._isConnected};h.prototype.isClosing=function(){return this._isClosing};h.prototype.connect=function(f){var l=this;this._sessionid=void 0;f=this.url+"/"+f+"?libversion="+g.Version;this._socket=""==this.subprotocol?new WebSocket(f,"Json"):new WebSocket(f,this.subprotocol);this._onConnecting();this._socket.onopen=function(n){};this._socket.onmessage=function(n){n=l._decode(n.data);l._onMessage(n.toString())};this._socket.onclose=function(n){l._logger.debug("onclose: wasClean =",
n.wasClean,", code =",n.code,", reason =",n.reason);l._isConnecting?l._onConnectFailed(n):(1006==n.code&&l._onTimeout(),l._onDisconnect())};this._socket.onerror=function(n){l._onError(n)}};h.prototype.disconnect=function(){this._isClosing=!0;this._socket&&this._socket.close()};h.prototype.sendOperation=function(f,l,n,q){f={req:f,vals:[]};g.Util.isArray(l)?f.vals=l:void 0===l?f.vals=[]:this._logger.exception(201,"PhotonPeer[sendOperation] - Trying to send non array data:",l);this._send(f);this._logger.debug("PhotonPeer[sendOperation] - Sending request:",
...
f.res){var l=parseInt(f.res);this._parseResponse(l,f)}else void 0!==f.evt?(l=parseInt(f.evt),this._parseEvent(l,f)):void 0!==f.irs?(l=parseInt(f.irs),this._parseInternalResponse(l,f)):this._logger.exception(204,"PhotonPeer[_onMessageReceived] - Received undefined message type:",f)};h.prototype._parseMessageValuesArrayToJSON=function(f){var l={};if(g.Util.isArray(f))if(0==f.length%2)for(var n,q;0<f.length;)n=f.shift()+"",q=f.shift(),l[n]=q;else this._logger.exception(205,"PhotonPeer[_parseMessageValuesToJSON] - Received invalid values array:",
...
function(f,l,n){l in f||(f[l]=[]);n&&"function"===typeof n?(this._logger.debug("PhotonPeer[_addListener] - Adding listener for event",l),f[l].push(n)):this._logger.error("PhotonPeer[_addListener] - Listener",l,"is not a function but of type",typeof n,". No listener added!");return this};h.prototype._dispatch=function(f,l,n,q){if(l in f){f=f[l];l=0;for(q=f.length;l<q;l++)g.Util.isArray(n)||(n=[n]),f[l].apply(this,void 0===n?[]:n);return!0}return!1};h.prototype._dispatchPeerStatus=function(f){this._dispatch(this._peerStatusListeners,
...
function(a,b){return g.Util.getPropertyOrElse(this.customProperties,a,b)};e.prototype.setCustomProperty=function(a,b,c,m){var k;void 0===c&&(c=!1);var u={};u[a]=b;var v;void 0!==m&&(v=(k={},k[a]=m,k));(k=this.loadBalancingClient&&this.loadBalancingClient.isJoinedToRoom())&&this.loadBalancingClient&&this.loadBalancingClient._setPropertiesOfActor(this.actorNr,u,c,v);k&&void 0!==m||(this.customProperties[a]=b,this.onPropertiesChange(u,!0))};e.prototype.setCustomProperties=function(a,b,c){void 0===b&&
(b=!1);var m=this.loadBalancingClient&&this.loadBalancingClient.isJoinedToRoom();m&&this.loadBalancingClient&&this.loadBalancingClient._setPropertiesOfActor(this.actorNr,a,b,c);if(!m||void 0===c){for(var k in a)this.customProperties[k]=a[k];this.onPropertiesChange(a,!0)}};e.prototype.isSuspended=function(){return this.suspended};e.prototype._getAllProperties=function(){var a={};a[d.Constants.ActorProperties.PlayerName]=this.name;for(var b in this.customProperties)a[b]=this.customProperties[b];return a};
...
e.prototype.requestLobbyStats=function(a){if(this.masterPeer&&this.isConnectedToMaster()){this.lobbyStatsRequestList=[];if(a)if("object"==typeof a)for(var b=0;b<a.length;++b){var c=a[b];if("object"==typeof c){var m=c[0];if(m){if(void 0===c[1])c=d.Constants.LobbyType.Default;else if("number"==typeof c[1])c=c[1];else{this.requestLobbyStatsErr("Lobby type is invalid",b);return}this.lobbyStatsRequestList[b]=[m.toString(),c]}else{this.requestLobbyStatsErr("Lobby name is empty",b);return}}else{this.requestLobbyStatsErr("Lobby id is not an array",
...
e.prototype.purgeRemovedRooms=function(){this.roomInfos=this.roomInfos.filter(function(b){return!b.removed});for(var a in this.roomInfosDict)this.roomInfosDict[a].removed&&delete this.roomInfosDict[a]};e.prototype.addActor=function(a){this.actors[a.actorNr]=a;this.actorsArray.push(a);this.currentRoom.playerCount=this.actorsArray.length;if(0==this.lowestActorId||this.lowestActorId>a.actorNr)this.lowestActorId=a.actorNr};e.prototype.removeActor=function(a){delete this.actors[a];this.actorsArray=this.actorsArray.filter(function(b){return b.actorNr!=
a});this.currentRoom.playerCount=this.actorsArray.length;this.lowestActorId==a&&(this.lowestActorId=0<this.actorsArray.length?this.actorsArray.reduce(function(b,c){return b.actorNr<c.actorNr?b:c}).actorNr:0)};e.prototype.clearActors=function(){this.actors={};this.actorsArray=[];this.lowestActorId=this.currentRoom.playerCount=0};e.prototype.changeState=function(a){this.logger.info("State:",e.StateToName(this.state()),"->",e.StateToName(a));this.state_=a;this.onStateChange(a)};e.prototype.createRoomInternal=
function(a,b){var c=[];this.currentRoom.name&&c.push(d.Constants.ParameterCode.RoomName,this.currentRoom.name);this.fillCreateRoomOptions(c,b,d.Constants.ParameterCode.GameProperties);a===this.masterPeer&&(this.createRoomOptions=b);a===this.gamePeer&&(c.push(d.Constants.ParameterCode.PlayerProperties),c.push(this._myActor._getAllProperties()));var m=a==this.gamePeer?this.gamePeer._logger:this.masterPeer?this.masterPeer._logger:null;m&&m.info("Create Room",b&&b.lobbyName,b&&b.lobbyType,"...");a.sendOperation(d.Constants.OperationCode.CreateGame,
...
b.changeState(e.State.Error);b._onErrorInternal(e.PeerErrorCode.NameServerConnectClosed,"NameServer server closed connection")});a.addResponseListener(d.Constants.OperationCode.GetRegions,function(c){a._logger.debug("resp GetRegions",c);var m={};if(0==c.errCode){var k=c.vals[d.Constants.ParameterCode.Region],u=c.vals[d.Constants.ParameterCode.Address],v;for(v in k)m[k[v]]=u[v]}else a._logger.error("GetRegions request error.",c.errCode);b.onGetRegionsResult(c.errCode,c.errMsg,m)});a.addResponseListener(d.Constants.OperationCode.Authenticate,
...
b.userId),b.connectOptions.lobbyStats&&c.push(d.Constants.ParameterCode.LobbyStats,!0),a.sendOperation(d.Constants.OperationCode.Authenticate,c),a._logger.info("Authenticate..."))});a.addPeerStatusListener(g.PhotonPeer.StatusCodes.disconnect,function(){a==b.masterPeer&&(b._cleanupMasterPeerData(),a._logger.info("Disconnected"))});a.addPeerStatusListener(g.PhotonPeer.StatusCodes.connectClosed,function(){a._logger.info("Server closed connection");b.changeState(e.State.Error);b._onErrorInternal(e.PeerErrorCode.MasterConnectClosed,
"Master server closed connection")});a.addEventListener(d.Constants.EventCode.GameList,function(c){c=c.vals[d.Constants.ParameterCode.GameList];b.clearRooms();for(var m in c){var k=new f(m);k._updateFromProps(c[m]);b.addRoom(k)}b.onRoomList(b.roomInfos);a._logger.debug("ev GameList",b.roomInfos,c)});a.addEventListener(d.Constants.EventCode.GameListUpdate,function(c){c=c.vals[d.Constants.ParameterCode.GameList];var m=[],k=[],u=[],v;for(v in c){var w=b.roomInfos.filter(function(x){return x.name==v});
0<w.length?(w=w[0],w._updateFromProps(c[v]),w.removed?u.push(w):m.push(w)):(w=new f(v),w._updateFromProps(c[v]),b.addRoom(w),k.push(w))}b.purgeRemovedRooms();b.onRoomListUpdate(b.roomInfos,m,k,u);a._logger.debug("ev GameListUpdate:",b.roomInfos,"u:",m,"a:",k,"r:",u,c)});a.addResponseListener(d.Constants.OperationCode.Authenticate,function(c){a._logger.debug("resp Authenticate",c);c.errCode?(b.changeState(e.State.Error),b._onErrorInternal(e.PeerErrorCode.MasterAuthenticationFailed,"Master authentication failed: "+
...
c.errCode);else for(var k=c.vals[d.Constants.ParameterCode.FindFriendsResponseOnlineList]||{},u=c.vals[d.Constants.ParameterCode.FindFriendsResponseRoomIdList]||{},v=0;v<b.findFriendsRequestList.length;++v){var w=b.findFriendsRequestList[v];w&&(m[w]={online:k[v],roomId:u[v]})}b.onFindFriendsResult(c.errCode,c.errMsg,m)});a.addResponseListener(d.Constants.OperationCode.LobbyStats,function(c){a._logger.debug("resp LobbyStats",c);var m=[];if(c.errCode)a._logger.error("LobbyStats request error:",c.errCode);
else{var k=c.vals[d.Constants.ParameterCode.LobbyName],u=c.vals[d.Constants.ParameterCode.LobbyType]||{},v=c.vals[d.Constants.ParameterCode.PeerCount]||{},w=c.vals[d.Constants.ParameterCode.GameCount]||{};if(k)for(var x=0;x<k.length;++x)m[x]={lobbyName:k[x],lobbyType:u[x],peerCount:v[x],gameCount:w[x]};else for(x=0;x<b.lobbyStatsRequestList.length;++x)k=b.lobbyStatsRequestList[x],m[x]={lobbyName:k[0],lobbyType:k[1],peerCount:v[x],gameCount:w[x]}}b.onLobbyStats(c.errCode,c.errMsg,m)});a.addEventListener(d.Constants.EventCode.LobbyStats,
function(c){a._logger.debug("ev LobbyStats",c);var m=[],k=c.vals[d.Constants.ParameterCode.LobbyName],u=c.vals[d.Constants.ParameterCode.LobbyType]||{},v=c.vals[d.Constants.ParameterCode.PeerCount]||{};c=c.vals[d.Constants.ParameterCode.GameCount]||{};if(k)for(var w=0;w<k.length;++w)m[w]={lobbyName:k[w],lobbyType:u[w],peerCount:v[w],gameCount:c[w]};b.onLobbyStats(0,"",m)});a.addEventListener(d.Constants.EventCode.AppStats,function(c){a._logger.debug("ev AppStats",c);b.onAppStats(0,"",{peerCount:c.vals[d.Constants.ParameterCode.PeerCount],
...
{Default:0,CreateIfNotExists:1,RejoinOnly:3};e.PeerErrorCode={Ok:0,MasterError:1001,MasterConnectFailed:1002,MasterConnectClosed:1003,MasterTimeout:1004,MasterEncryptionEstablishError:1005,MasterAuthenticationFailed:1101,GameError:2001,GameConnectFailed:2002,GameConnectClosed:2003,GameTimeout:2004,GameEncryptionEstablishError:2005,GameAuthenticationFailed:2101,NameServerError:3001,NameServerConnectFailed:3002,NameServerConnectClosed:3003,NameServerTimeout:3004,NameServerEncryptionEstablishError:3005,
...
p[e.State.ConnectedToMaster]="ConnectedToMaster",p[e.State.JoinedLobby]="JoinedLobby",p[e.State.ConnectingToGameserver]="ConnectingToGameserver",p[e.State.ConnectedToGameserver]="ConnectedToGameserver",p[e.State.Joined]="Joined",p[e.State.Disconnected]="Disconnected",p);return e}();d.LoadBalancingClient=n;n=function(e){function a(){return null!==e&&e.apply(this,arguments)||this}__extends(a,e);a.prototype.webRpc=function(b,c,m){var k=[];k.push(d.Constants.ParameterCode.UriPath,b);k.push(d.Constants.ParameterCode.RpcCallParams,
c);m&&m.sendAuthCookie&&k.push(d.Constants.ParameterCode.WebFlags,g.TypeExt.Byte(2));this.sendOperation(d.Constants.OperationCode.Rpc,k)};a.prototype.webRpcHandler=function(b){var c=this;return function(m){c._logger.debug("resp Rpc",m);if(0==m.errCode){var k=m.vals[d.Constants.ParameterCode.UriPath];var u=m.vals[d.Constants.ParameterCode.RpcCallRetData];var v=m.vals[d.Constants.ParameterCode.RpcCallRetCode]}else c._logger.error("WebRpc request error:",m.errCode);b.onWebRpcResult(m.errCode,m.errMsg,
k,v,u)}};return a}(g.PhotonPeer);d.LbcPeer=n;var q=function(e){function a(b,c,m,k){c=e.call(this,c,m,k,b.logger.getPrefix()+" NameServer")||this;c.client=b;return c}__extends(a,e);a.prototype.onUnhandledEvent=function(b,c){this.client.onEvent(b,c.vals[d.Constants.ParameterCode.CustomEventContent],c.vals[d.Constants.ParameterCode.ActorNr])};a.prototype.onUnhandledResponse=function(b,c){this.client.onOperationResponse(c.errCode,c.errMsg,b,c.vals)};a.prototype.getRegions=function(b){var c=[];c.push(d.Constants.ParameterCode.ApplicationId,
b);this.sendOperation(d.Constants.OperationCode.GetRegions,c,!0,0)};a.prototype.opAuth=function(b,c,m,k,u,v,w){var x=[];x.push(d.Constants.ParameterCode.ApplicationId,b);x.push(d.Constants.ParameterCode.AppVersion,c);m!=d.Constants.CustomAuthenticationType.None&&(x.push(d.Constants.ParameterCode.ClientAuthenticationType,g.TypeExt.Byte(m)),x.push(d.Constants.ParameterCode.ClientAuthenticationParams,k),u&&x.push(d.Constants.ParameterCode.ClientAuthenticationData,u));v&&x.push(d.Constants.ParameterCode.UserId,
v);x.push(d.Constants.ParameterCode.Region,w);this.sendOperation(d.Constants.OperationCode.Authenticate,x,!0,0);this._logger.info("Authenticate...")};return a}(n);d.NameServerPeer=q;var r=function(e){function a(b,c,m,k){c=e.call(this,c,m,k,b.logger.getPrefix()+" Master")||this;c.client=b;return c}__extends(a,e);a.prototype.onUnhandledEvent=function(b,c){this.client.onEvent(b,c.vals[d.Constants.ParameterCode.CustomEventContent],c.vals[d.Constants.ParameterCode.ActorNr])};a.prototype.onUnhandledResponse=
function(b,c){this.client.onOperationResponse(c.errCode,c.errMsg,b,c.vals)};a.prototype.findFriends=function(b){var c=[];c.push(d.Constants.ParameterCode.FindFriendsRequestList);c.push(b);this.sendOperation(d.Constants.OperationCode.FindFriends,c)};a.prototype.requestLobbyStats=function(b){var c=[];if(b&&0<b.length){for(var m=[],k=[],u=0;u<b.length;++u)m[u]=b[u][0],k[u]=b[u][1];c.push(d.Constants.ParameterCode.LobbyName);c.push(m);c.push(d.Constants.ParameterCode.LobbyType);c.push(k)}this.sendOperation(d.Constants.OperationCode.LobbyStats,
c)};return a}(n);d.MasterPeer=r;var t=function(e){function a(b,c,m,k){var u=e.call(this,c,m,k,b.logger.getPrefix()+" Game")||this;u.client=b;u.onEventNative=function(v,w){return u.client.onEventNative?u.client.onEventNative(v,w):!1};return u}__extends(a,e);a.prototype.onUnhandledEvent=function(b,c){this.client.onEvent(b,c.vals[d.Constants.ParameterCode.CustomEventContent],c.vals[d.Constants.ParameterCode.ActorNr])};a.prototype.onUnhandledResponse=function(b,c){this.client.onOperationResponse(c.errCode,
c.errMsg,b,c.vals)};a.prototype.raiseEvent=function(b,c,m){if(this.client.isJoinedToRoom())this._logger.debug("raiseEvent",b,c,m),b=[d.Constants.ParameterCode.Code,g.TypeExt.Byte(b),d.Constants.ParameterCode.Data,c],m&&(void 0!=m.receivers&&m.receivers!==d.Constants.ReceiverGroup.Others&&(b.push(d.Constants.ParameterCode.ReceiverGroup),b.push(g.TypeExt.Byte(m.receivers))),void 0!=m.cache&&m.cache!==d.Constants.EventCaching.DoNotCache&&(b.push(d.Constants.ParameterCode.Cache),b.push(g.TypeExt.Byte(m.cache))),
...
(function(g){g.IsEmscriptenBuild=g.IsEmscriptenBuildInternal;g.Version="4.2.0.0"})(Photon||(Photon={}));
