...
var DemoConstants = {
    ...
    LogLevel: Photon.LogLevel.DEBUG
};
var Demo = /** @class */ (function (_super) {
    ...
    function Demo(canvas) {
        ...
        _this.logger = new Photon.Logger("Demo:", DemoConstants.LogLevel);
...
var Output = /** @class */ (function () {
    ...
    Output.logger = new Photon.Logger();
    return Output;
}());
...
Photon.setOnLoad(function () {
    return window.onload = function () { return new Demo(document.getElementById("canvas")).start(); };
});
